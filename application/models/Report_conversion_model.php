...
class Report_conversion_model extends CI_Model {
    ...
    public function update_missing_conversion($a_set) {
        $missing_conversion = $this->get_missing_conversion_by_id($a_set['uuid'], $a_set['campaign_id'], $a_set['order_id']);
    ...
    public function get_missing_conversion_by_id($uuid, $campaign_id, $order_id) {
