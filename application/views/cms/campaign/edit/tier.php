...
<div class="px-5 mb-3">
  ...
  <?php foreach($a_custom_reward as $type => $custom_rewards) { ?>
    <div class="py-2" id="<?php echo $type.'Form' ?>">
        ...
        <div class="row align-items-center px-3">
          ...
          <div class="col-md-2">
            <div class="form-group">
              <input type="number" step="0.01" id="<?php echo $id ?>" name="a_custom_reward[<?php echo $type ?>][<?php echo $key ?>]" class="form-control" value="<?php echo $value ?>">
            </div>
          </div>
          <div class="col-md-1">
