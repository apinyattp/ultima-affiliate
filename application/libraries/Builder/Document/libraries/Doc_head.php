...
class Doc_head {
    private $_css = array(
        'document/vendor/bootstrap/css/bootstrap.min.css',
        'document/dist/css/sb-admin-2.css',
        'document/fontawesome/css/all.min.css',
    );
    private $_css_media = array();

    private $_js = array(
        'document/vendor/jquery/jquery.min.js',
        'document/vendor/bootstrap/js/bootstrap.min.js',
        'document/vendor/metisMenu/metisMenu.min.js',
        'document/vendor/raphael/raphael.min.js',
        'document/dist/js/sb-admin-2.js',
    );
    ...
    public function param_load($param) {
        foreach (array('css_path', 'css', 'css_media', 'js_path', 'js', 'html', 'title', 'description', 'keyword', 'image_src', 'image_banner', 'head_script', 'a_language_disable', 'a_language_link') as $key) {
     ...
     *  @return void
     * */
    public function css_add($css, $media='screen') {
        $this->_css[] = $css;
     ...
     *  @return array/string
     * */
    public function css_get($render=TRUE) {
     ...
     *  @return array/string
     * */
    public function js_get($render=TRUE) {
    ...
    public function top_title($title=FALSE) {
     ...
     *  @return void
     * */
    public function keyword($keyword=FALSE) {
     ...
     *  @return void
     * */
    public function image_src($image_src=FALSE) {
     ...
     *  @return void
     * */
    public function image_banner($image_banner=FALSE) {
     ...
     * @return void
     */
    public function script_add($script) {
     ...
     * @return void
     */
    public function language_disable_add($language) {
     ...
     * @return array
     */
    public function language_disable_get() {
     ...
     * @return void
     */
    public function language_link_set($lang, $url) {
     ...
     * @return array
     */
    public function language_link_get() {
        return $this->_a_language_link;
    }

    public function menu_select($menu=FALSE) {
        if($menu !== FALSE) $this->_menu = $menu;
        return $this->_menu;
    }

    public function var_add($var_name, $value) {
        $this->_a_var[$var_name] = $value;
    }

    public function var_get($var_name, $default=FALSE) {
        if(!isset($this->_a_var[$var_name])) return $default;
        return $this->_a_var[$var_name];
    }

    public function back_url($url=FALSE) {
        if($url !== FALSE) $this->_back_url = $url;
        return $this->_back_url;
    }

    public function breadcrumb($a_breadcrumb=FALSE) {
